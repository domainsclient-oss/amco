...
export default function WaferFlangedButterflyValvePage() {
  ...
  const specs = [
    ...
    { label: "End connection", value: "Flanged to suit ANSI & ND flanges" },
  ...
  const handleDownloadCSV = () => {
    ...
    const rows = [
      ["Product", "Wafer Flanged BFV"],
      ["Category", "Butterfly Valve"],
      ["Sub Category", "Centric Disc Design"],
      ["Model", "Wafer Flanged PN10# / PN16# / PN20# / PN25#"],
    ...
    link.setAttribute("download", `Wafer_Flanged_BFV_data_sheet.csv`);
    ...
    <main className="min-h-screen bg-white">
      ...
      <div className="bg-neutral-50 pt-32 pb-8 px-5 md:px-[63px]">
        <div className="container mx-auto">
          ...
          <h1 className="text-3xl md:text-4xl font-bold text-primary mt-2">Wafer Flanged PN10# / PN16# / PN20# / PN25#</h1>
        </div>
      </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 md:gap-20 items-start mb-20">
            <div className="relative aspect-square rounded-[2rem] overflow-hidden bg-white border border-border shadow-lg">
              <Image
                ...
                alt="Wafer Flanged Butterfly Valve"
                fill
                ...
                <Table className="border-collapse w-full">
                  <TableHeader>
                    <TableRow className="bg-white border-b border-neutral-300">
                      <TableHead colSpan={6} className="text-center font-bold text-primary uppercase py-6">WAFER FLANGED BFV</TableHead>
                    </TableRow>
